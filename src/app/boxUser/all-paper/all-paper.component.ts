...
@Component({
  selector: 'app-all-paper',
  templateUrl: './all-paper.component.html',
  styleUrl: './all-paper.component.css',
  imports: [
    HeaderComponent,
    SideBarComponent,
    NgFor,
...
export class AllPaperComponent implements OnInit {
  // ตัวแปร
  php:any = 'user/allPaper'
  table:any = 'paper'
  user:any
  data:any
  length:number = 0
